...
const COMMANDS: Command[] = [
  ...
  { id: 'contacts',     label: 'Mijozlar',        path: '/contacts',            icon: Users,           category: 'Asosiy',    keywords: 'mijozlar yetkazuvchilar kontragent' },
  ...
  { id: 'cash',         label: 'Kassa xarajatlari', path: '/cash-expenses',     icon: DollarSign,      category: 'Asosiy',    keywords: 'chiqim haydovchi expense' },
  { id: 'recurring',    label: 'Takroriy operatsiyalar', path: '/recurring',    icon: BarChart2,       category: 'Asosiy',    keywords: 'oylik ijara takror' },
  { id: 'reports',      label: 'Hisobotlar',      path: '/reports',             icon: BarChart2,       category: 'Asosiy',    keywords: 'analytics statistics' },
  { id: 'smart',        label: 'Smart Tahlil',    path: '/smart',               icon: Brain,           category: 'AI',        keywords: 'ai analytics insights' },
  { id: 'deals',        label: 'Bitimlar (CRM)',  path: '/sales',               icon: TrendingUp,      category: 'Modullar',  keywords: 'crm savdo pipeline' },
  { id: 'waste',        label: 'Chiqindi',        path: '/waste',               icon: Recycle,         category: 'Modullar',  keywords: 'qayta ishlash' },
  { id: 'construction', label: 'Qurilish',        path: '/construction/objects', icon: HardHat,        category: 'Modullar',  keywords: 'project loyiha' },
  { id: 'production',   label: 'Ishlab chiqarish',path: '/production/batches',  icon: Factory,         category: 'Modullar',  keywords: 'batch partiya' },
  { id: 'service',      label: 'Xizmat',          path: '/service',             icon: FileText,        category: 'Modullar',  keywords: 'service ticket' },
  { id: 'import',       label: 'Import markazi',  path: '/import',              icon: Upload,          category: 'Sozlamalar',keywords: '1c excel migrate' },
  { id: 'settings',     label: 'Sozlamalar',      path: '/settings',            icon: Settings,        category: 'Sozlamalar',keywords: 'config profile' },
]
